...
class CXR_ImageText(LightningModule):
    ...
    def _step(self, batch: Any, stage: str = "train"):
        ...
        change_labels = batch['change_labels']
        disease_labels = batch['disease_labels']
        base_img = batch['base_imgs']
        pair_img = batch['pair_imgs']
        
        base_embed, fu_embed, outputs, matching = self.model(caption_ids, token_type_ids, 
                                                             attention_mask, base_img, pair_img)
