...
class CaiT(nn.Module):
    def __init__(
        ...
        *,
        ...
        self.to_patch_embedding = nn.Sequential(
            Rearrange('b 1 (h p1) (w p2) -> b (h w) (p1 p2 1)', p1 = patch_size, p2 = patch_size),
    ...
    def forward(self, img, img2):
        ...
        x2 = self.patch_transformer(x2)

        cls_tokens2 = repeat(self.cls_token2, '() n d -> b n d', b = b)
        x2 = self.cls_transformer(cls_tokens2, context = x2)
        x2 = self.mlp_head(x2[:, 0])
