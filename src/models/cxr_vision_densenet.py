...
class DenseNet(nn.Module):
    ...
    def __init__(
        ...
        # Linear layer
        self.classifier = nn.Linear(num_features, num_label)
    ...
    def forward(self, x1, x2) -> Tensor:
        ...
        out1 = self.disease_linear(out1)
        out2 = self.disease_linear(out2)
...
def densenet121(*, pretrained = False, progress = True, **kwargs):
    ...
    return _densenet(32, (6, 12, 24, 16), 64, pretrained, progress, **kwargs)