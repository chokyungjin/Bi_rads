...
from src.models.stochastic_depth import StochasticDepth

from src.models.misc import Conv2dNormActivation, SqueezeExcitation
...
def efficientnet_b3(*, pretrained = None, progress: bool = True, **kwargs: Any) -> EfficientNet:
    ...
    return _efficientnet(inverted_residual_setting, 0.3, last_channel, pretrained, progress, **kwargs)

def efficientnet_b4(*, pretrained = None, progress: bool = True, **kwargs: Any) -> EfficientNet:
    ...
    return _efficientnet(inverted_residual_setting, 0.4, last_channel, pretrained, progress, **kwargs)

def efficientnet_b5(*, pretrained = None, progress: bool = True, **kwargs: Any) -> EfficientNet:
