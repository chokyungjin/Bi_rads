...
from src.models import cxr_mm_model
from src.models import cxr_vision_resnet, cxr_vision_densenet, cxr_vision_efficientnetv2, cxr_vision_inceptionv3
from src.models import cxr_vision_cait, cxr_vision_coat, cxr_vision_convnext
...
def main(args):
    ...
    model = cxr_mm_model.CXRTextGuidedModel(
                        in_channels= 1,
                        stem_channels= 16,
                        ...
                        num_labels= 2,
                        freeze_bert= True,
                        cxr_bert_pretrained = '/mnt/nas252/forGPU/Kyungjin.Cho/_jykim/mm/FU_trainer/logs/CXR_FU_text/230211_v3_only_fu/2023-02-11_16-28-37/checkpoints/epoch_043.ckpt',
