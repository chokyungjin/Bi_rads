...
#         dict_sec = {'imgs': [], 'change_labels':[], 
#                     'disease_labels':[], 'reports':[], 
#                     'patient_id':[], 'fov':[], 'fov_fail': []}

#         dict_sec['imgs'] = json_file['imgs'][i]
#         dict_sec['change_labels'] = json_file['change_labels'][i]
#         dict_sec['disease_labels'] = label_process(json_file, i, d_num)
#         dict_sec['reports'] = json_file['reports'][i]
#         dict_sec['patient_id'] = json_file['patient_id'][i]
#         dict_sec['fov'] = json_file['fov'][i]
#         dict_sec['fov_fail'] = json_file['fov'][i]

#         filenames.append(dict_sec)
